...
#> Chain 1 finished in 54.6 seconds.
#> 
#> Both chains finished successfully.
#> Mean chain execution time: 51.1 seconds.
#> Total execution time: 54.7 seconds.
#> 
#> Warning: 1 of 2 chains had an E-BFMI less than 0.3.
#> See https://mc-stan.org/misc/warnings for details.
#> Saving model output to /home/runner/work/bbsBayes2/bbsBayes2/docs/reference/BBS_PacificWren_first_diff_hier_202512122126_STAN.rds
```
