...
#'
#' Generate a faceted plot of population trajectories by province/state. Only
...
#'
#' @param multiple Logical. Whether to plot multiple strata-level trajectories
#'   within each prov/state facet. Default `FALSE`.
...
#'   `plot_map`.
#' @param slope Logical. If `trends` included, whether colours in the plot
#'   should be based on slope trends. Default `FALSE`.
#'
