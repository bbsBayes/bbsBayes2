...
#' @param calculate_cv Logical. Whether to use bbsBayes2' cross validation.
...
#' `folds` list-item in the output of `prepare_model()`. **Note this is
...
cv_folds <- function(raw_data,
  ...
  if(!quiet) message("Note that bbsBayes2 cross validation is experimental!")
