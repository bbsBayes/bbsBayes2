...
- Short 3-line code changes to the model files for the hierarchical
  variants of the GAM and GAMYE. A change in version 1.2026.3 created an
  indexing error in these models. Those indexing errors are fixed here.
