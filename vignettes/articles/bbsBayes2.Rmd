...
Many of the bbsBayes2 functions require identifying a species using
English names; The `search_species()` function allows the user to search
up English names using Spanish, French, or Latin names.
...
#>      aou english                                         french spanish order family genus species unid_combined
#>    <dbl> <chr>                                           <chr>  <chr>   <chr> <chr>  <chr> <chr>   <lgl>        
#>  1  4840 Canada Jay                                      "M\u0… Periso… Pass… Corvi… Peri… canade… TRUE         
...
Note: if you're just exploring the package functionality, we recommend
...
<img src="figures/bbsBayes2_unnamed-chunk-30-1.png" alt="Population trajectory graph, showing the estimated annual relative abundances, their associated 95% credible intervals, and points representing the raw mean observed counts."  />
...
<img src="figures/bbsBayes2_unnamed-chunk-31-1.png" alt="Population trajectory graph, modified to show only the last 20 years of the time-series and remove the title"  />
...
<img src="figures/bbsBayes2_unnamed-chunk-34-1.png" alt="Population trend map showing strata with increasing trends in blues and decreasing trends in reds."  />
...
<img src="figures/bbsBayes2_unnamed-chunk-35-1.png" alt="Population trend map zoomed in to show just the relevant regions"  />
...
<img src="figures/bbsBayes2_unnamed-chunk-36-1.png" alt="Population trajectory graph for Barn Swallow, showing the estimated annual relative abundances, their associated 95% credible intervals, and points representing the raw mean observed counts."  />
...
<img src="figures/bbsBayes2_unnamed-chunk-37-1.png" alt="Population trend map for Barn Swallow, showing strata with increasing trends in shades of blue and strata with decreasing trends in shades of red"  />
...
<img src="figures/bbsBayes2_unnamed-chunk-38-1.png" alt="Population trajectory graph for Barn Swallow, same as above plus the smoothed annual indices are added as a grey line"  />
