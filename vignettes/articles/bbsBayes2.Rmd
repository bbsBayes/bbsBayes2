...
-   Annual releases `2020`, `2022`, `2023`, '2024', and `2025` more options will be added as annual releases occur).

The defaults (level `state` and the most recent release - `2025`) is almost certainly what you are looking for, Unless you have a specific reason to need a different version. The most recent release will include all of the data included in earlier releases.
...
#>   Joining routes to spatial layer...
#>   Renaming routes...
#>   Omitting 492/5,366 surveys, on 25 unique routes that do not match a stratum.
#>     To see omitted routes use `return_omitted = TRUE` (see ?stratify)
```

Stratifications included in bbsBayes2 are
bbs, bbs_usgs, bbs_cws, bcr, bcr_old, latlong, prov_state. See the article on
...
#>      aou english                                            french       order family genus species unid_combined
#>    <dbl> <chr>                                              <chr>        <chr> <chr>  <chr> <chr>   <lgl>        
#>  1  4840 Canada Jay                                         Mésangeai d… Pass… Corvi… Peri… canade… TRUE         
#>  2  4830 Green Jay                                          Geai vert    Pass… Corvi… Cyan… yncas   TRUE         
#>  3  4920 Pinyon Jay                                         Geai des pi… Pass… Corvi… Gymn… cyanoc… TRUE         
#>  4  4780 Steller's Jay                                      Geai de Ste… Pass… Corvi… Cyan… stelle… TRUE         
#>  5  4770 Blue Jay                                           Geai bleu    Pass… Corvi… Cyan… crista… TRUE         
#>  6  4790 Florida Scrub-Jay                                  Geai à gorg… Pass… Corvi… Aphe… coerul… TRUE         
#>  7  4811 Island Scrub-Jay                                   Geai de San… Pass… Corvi… Aphe… insula… TRUE         
#>  8  4812 California Scrub-Jay                               Geai buisso… Pass… Corvi… Aphe… califo… TRUE         
#>  9  4813 Woodhouse's Scrub-Jay                              Geai de Woo… Pass… Corvi… Aphe… woodho… TRUE         
#> 10  4810 unid. California Scrub-Jay / Woodhouse's Scrub-Jay unid Geai b… Pass… Corvi… Aphe… califo… TRUE         
#> 11  4820 Mexican Jay                                        Geai du Mex… Pass… Corvi… Aphe… wollwe… TRUE         
#> 12  4910 Clark's Nutcracker                                 Cassenoix d… Pass… Corvi… Nuci… columb… TRUE         
#> 13  4750 Black-billed Magpie                                Pie d'Améri… Pass… Corvi… Pica  hudson… TRUE         
#> 14  4760 Yellow-billed Magpie                               Pie à bec j… Pass… Corvi… Pica  nuttal… TRUE         
#> 15  4880 American Crow                                      Corneille d… Pass… Corvi… Corv… brachy… TRUE         
#> 16  4900 Fish Crow                                          Corneille d… Pass… Corvi… Corv… ossifr… TRUE         
#> 17  4881 unid. American Crow / Fish Crow                    unid Cornei… Pass… Corvi… Corv… brachy… TRUE         
#> 18  4870 Chihuahuan Raven                                   Corbeau à c… Pass… Corvi… Corv… crypto… TRUE         
#> 19  4860 Common Raven                                       Grand Corbe… Pass… Corvi… Corv… corax   TRUE         
#> 20  4865 unid. Chihuahuan Raven / Common Raven              unid Grand … Pass… Corvi… Corv… crypto… TRUE
```
##### Species groupings
...
<img src="figures/bbsBayes2_unnamed-chunk-23-1.png" alt="Map showing the strata and neighbourhood relationships among them for Scissor-tailed Flycatcher"  />
...
rhat \> 1.1 indicate a *very serious* problem with the convergence of some of the
...
#>  1  1967 continent continent   US-AR-24 ; US-AR-25… ""              13.5          12.1         12.3         13.0 
#>  2  1968 continent continent   US-AR-24 ; US-AR-25… ""              13.5          12.2         12.4         13.0 
#>  3  1969 continent continent   US-AR-24 ; US-AR-25… ""              13.4          12.3         12.5         13.0 
#>  4  1970 continent continent   US-AR-24 ; US-AR-25… ""              13.5          12.5         12.6         13.2 
#>  5  1971 continent continent   US-AR-24 ; US-AR-25… ""              13.4          12.5         12.6         13.0 
#>  6  1972 continent continent   US-AR-24 ; US-AR-25… ""              13.2          12.4         12.5         12.9 
#>  7  1973 continent continent   US-AR-24 ; US-AR-25… ""              12.1          11.3         11.4         11.8 
#>  8  1974 continent continent   US-AR-24 ; US-AR-25… ""              11.4          10.7         10.8         11.2 
#>  9  1975 continent continent   US-AR-24 ; US-AR-25… ""              10.7          10.0         10.1         10.5 
#> 10  1976 continent continent   US-AR-24 ; US-AR-25… ""               9.84          9.19         9.29         9.60
#> # ℹ 1,556 more rows
#> # ℹ 8 more variables: index_q_0.75 <dbl>, index_q_0.95 <dbl>, index_q_0.975 <dbl>, obs_mean <dbl>,
#> #   n_routes <int>, n_routes_total <int>, n_non_zero <int>, backcast_flag <dbl>
```
### Trajectory plots
...
#> [10] "US_MO_22"  "US_MO_24"  "US_NM_18"  "US_NM_35"  "US_OK_18"  "US_OK_19"  "US_OK_21"  "US_OK_22"  "US_OK_24" 
#> [19] "US_OK_25"  "US_TX_18"  "US_TX_19"  "US_TX_20"  "US_TX_21"  "US_TX_25"  "US_TX_35"  "US_TX_36"  "US_TX_37"
```
...
<img src="figures/bbsBayes2_unnamed-chunk-36-1.png" alt="Population trajectory graph, showing the estimated annual relative abundances, their associated 95% credible intervals, and points representing the raw mean observed counts."  />
...
<img src="figures/bbsBayes2_unnamed-chunk-37-1.png" alt="Population trajectory graph, modified to show only the last 20 years of the time-series and remove the title"  />
...
<img src="figures/bbsBayes2_unnamed-chunk-38-1.png" alt="Population trajectory graph, showing a posterior sample of estimated trajectories as multiple overlapping lines, and points representing the raw mean observed counts."  />
...
#>  1       1967     2024 continent continent   US-AR-24 ; US-AR… ""              -0.965         -1.22        -1.18 
#>  2       1967     2024 US-AR-24  stratum     US-AR-24          ""               4.81           3.75         3.91 
#>  3       1967     2024 US-AR-25  stratum     US-AR-25          ""              -0.304         -1.10        -0.946
#>  4       1967     2024 US-AR-26  stratum     US-AR-26          ""               3.40           1.15         1.54 
#>  5       1967     2024 US-KS-18  stratum     US-KS-18          ""               2.75          -1.33        -0.650
#>  6       1967     2024 US-KS-19  stratum     US-KS-19          ""              -0.458         -1.23        -1.11 
#>  7       1967     2024 US-KS-22  stratum     US-KS-22          ""              -0.0114        -0.691       -0.587
#>  8       1967     2024 US-LA-25  stratum     US-LA-25          ""              -1.21          -2.79        -2.55 
#>  9       1967     2024 US-LA-37  stratum     US-LA-37          ""               0.301         -1.81        -1.47 
#> 10       1967     2024 US-MO-22  stratum     US-MO-22          ""               0.655         -0.979       -0.707
#> # ℹ 17 more rows
#> # ℹ 18 more variables: trend_q_0.25 <dbl>, trend_q_0.75 <dbl>, trend_q_0.95 <dbl>, trend_q_0.975 <dbl>,
#> #   percent_change <dbl>, percent_change_q_0.025 <dbl>, percent_change_q_0.05 <dbl>,
#> #   percent_change_q_0.25 <dbl>, percent_change_q_0.75 <dbl>, percent_change_q_0.95 <dbl>,
#> #   percent_change_q_0.975 <dbl>, width_of_95_percent_credible_interval <dbl>, rel_abundance <dbl>,
#> #   obs_rel_abundance <dbl>, n_routes <dbl>, mean_n_routes <dbl>, n_strata_included <dbl>, backcast_flag <dbl>
```
...
#>    start_year end_year region    region_type strata_included    strata_excluded  trend trend_q_0.025 trend_q_0.05
#>         <dbl>    <dbl> <chr>     <chr>       <chr>              <chr>            <dbl>         <dbl>        <dbl>
#>  1       2011     2021 continent continent   US-AR-24 ; US-AR-… ""              -2.15         -2.90        -2.77 
#>  2       2011     2021 US-AR-24  stratum     US-AR-24           ""               1.78         -0.972       -0.528
#>  3       2011     2021 US-AR-25  stratum     US-AR-25           ""              -0.634        -3.17        -2.67 
#>  4       2011     2021 US-AR-26  stratum     US-AR-26           ""               4.23         -1.20        -0.360
#>  5       2011     2021 US-KS-18  stratum     US-KS-18           ""               3.06         -3.01        -2.05 
#>  6       2011     2021 US-KS-19  stratum     US-KS-19           ""               0.602        -2.23        -1.76 
#>  7       2011     2021 US-KS-22  stratum     US-KS-22           ""              -3.80         -6.11        -5.67 
#>  8       2011     2021 US-LA-25  stratum     US-LA-25           ""              -1.94         -8.71        -7.74 
#>  9       2011     2021 US-LA-37  stratum     US-LA-37           ""               1.81         -4.87        -3.96 
#> 10       2011     2021 US-MO-22  stratum     US-MO-22           ""              -2.19         -6.90        -6.02 
#> # ℹ 17 more rows
#> # ℹ 18 more variables: trend_q_0.25 <dbl>, trend_q_0.75 <dbl>, trend_q_0.95 <dbl>, trend_q_0.975 <dbl>,
#> #   percent_change <dbl>, percent_change_q_0.025 <dbl>, percent_change_q_0.05 <dbl>,
#> #   percent_change_q_0.25 <dbl>, percent_change_q_0.75 <dbl>, percent_change_q_0.95 <dbl>,
...
#> $raw_data
#> # A tibble: 13,485 × 27
#>    country_num state_num state     rpid   bcr  year strata_name route   obs_n latitude longitude route_data_id
#>          <dbl>     <dbl> <chr>    <dbl> <dbl> <dbl> <chr>       <chr>   <dbl>    <dbl>     <dbl>         <dbl>
#>  1         840         7 ARKANSAS   101    26  1969 US-AR-24    7-19  1070050     35.9     -91.3       6167138
#>  2         840         7 ARKANSAS   101    26  1971 US-AR-24    7-19  1070050     35.9     -91.3       6168780
#>  3         840         7 ARKANSAS   101    26  1972 US-AR-24    7-19  1070050     35.9     -91.3       6174037
#>  4         840         7 ARKANSAS   101    26  1973 US-AR-24    7-19  1070050     35.9     -91.3       6174466
#>  5         840         7 ARKANSAS   101    26  1975 US-AR-24    7-19  1070050     35.9     -91.3       6179441
#>  6         840         7 ARKANSAS   101    26  1977 US-AR-24    7-19  1080130     35.9     -91.3       6183099
#>  7         840         7 ARKANSAS   101    26  1978 US-AR-24    7-19  1080130     35.9     -91.3       6187774
#>  8         840         7 ARKANSAS   101    26  1979 US-AR-24    7-19  1040020     35.9     -91.3       6185565
#>  9         840         7 ARKANSAS   101    26  1980 US-AR-24    7-19  1040020     35.9     -91.3       6186949
#> 10         840         7 ARKANSAS   101    26  1981 US-AR-24    7-19  1040020     35.9     -91.3       6191114
#> # ℹ 13,475 more rows
#> # ℹ 15 more variables: run_type <dbl>, count <dbl>, n_routes <int>, non_zero_weight <dbl>, first_year <dbl>,
#> #   max_n_routes_year <int>, n_obs <int>, mean_obs <dbl>, year_num <dbl>, strata <dbl>, observer <int>,
#> #   site <int>, obs_route <chr>, obs_site <int>, n_obs_sites <int>
```
...
<img src="figures/bbsBayes2_unnamed-chunk-42-1.png" alt="Population trend map showing strata with increasing trends in blues and decreasing trends in reds."  />
...
Swallow data, using the 2022 release `fetch_bbs_data(release = 2022)`](https://drive.google.com/file/d/1jFzzoJel6B2bg6yOmhMHnGTxkLaTRaRn/view?usp=sharing).
...
<img src="figures/bbsBayes2_unnamed-chunk-46-1.png" alt="Population trajectory graph for Barn Swallow, showing the estimated annual relative abundances, their associated 95% credible intervals, and points representing the raw mean observed counts."  />
...
<img src="figures/bbsBayes2_unnamed-chunk-47-1.png" alt="Population trend map for Barn Swallow, showing strata with increasing trends in shades of blue and strata with decreasing trends in shades of red"  />
...
<img src="figures/bbsBayes2_unnamed-chunk-48-1.png" alt="Population trajectory graph for Barn Swallow, same as above plus the smoothed annual indices are added as a grey line"  />
