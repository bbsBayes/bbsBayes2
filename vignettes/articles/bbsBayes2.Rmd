...
#> 1  4770 Blue Jay Geai bleu Cyanocitta cristata Passeriformes Corvidae Cyanocit… crista… TRUE
search_species("Cyanocitta")
#> # A tibble: 2 × 9
#>     aou english       french          spanish             order    family genus species unid_combined
#>   <dbl> <chr>         <chr>           <chr>               <chr>    <chr>  <chr> <chr>   <lgl>        
#> 1  4780 Steller's Jay Geai de Steller Cyanocitta stelleri Passeri… Corvi… Cyan… stelle… TRUE         
#> 2  4770 Blue Jay      Geai bleu       Cyanocitta cristata Passeri… Corvi… Cyan… crista… TRUE
...
#> 10  4810 unid. California Scrub-Jay / Woodho… unid … Aphelo… Pass… Corvi… Aphe… califo… TRUE         
#> # ℹ 12 more rows
```
##### Species groupings
...
#>    start_year end_year region    region_type strata_included     strata_excluded  trend trend_q_0.025
#>         <dbl>    <dbl> <chr>     <chr>       <chr>               <chr>            <dbl>         <dbl>
#>  1       2011     2021 continent continent   US-AR-24 ; US-AR-2… ""              -2.39          -3.21
