...
#>     aou english       french          order         family genus species unid_combined
#>   <dbl> <chr>         <chr>           <chr>         <chr>  <chr> <chr>   <lgl>        
#> 1  4780 Steller's Jay Geai de Steller Passeriformes Corvi… Cyan… stelle… TRUE         
#> 2  4770 Blue Jay      Geai bleu       Passeriformes Corvi… Cyan… crista… TRUE
...
#> 10  4810 unid. California Scrub-Jay /… unid … Pass… Corvi… Aphe… califo… TRUE         
...
#> 17  4881 unid. American Crow / Fish C… unid … Pass… Corvi… Corv… brachy… TRUE         
#> 18  4870 Chihuahuan Raven              Corbe… Pass… Corvi… Corv… crypto… TRUE         
#> 19  4860 Common Raven                  Grand… Pass… Corvi… Corv… corax   TRUE         
#> 20  4865 unid. Chihuahuan Raven / Com… unid … Pass… Corvi… Corv… crypto… TRUE
```
##### Species groupings
...
i[["indices"]]
#> # A tibble: 1,482 × 17
#>     year region    region_type strata_included     strata_excluded index index_q_0.025
#>    <dbl> <chr>     <chr>       <chr>               <chr>           <dbl>         <dbl>
#>  1  1967 continent continent   US-AR-24 ; US-AR-2… ""              13.1          11.7 
#>  2  1968 continent continent   US-AR-24 ; US-AR-2… ""              12.9          11.8 
#>  3  1969 continent continent   US-AR-24 ; US-AR-2… ""              12.9          12.0 
#>  4  1970 continent continent   US-AR-24 ; US-AR-2… ""              12.9          12.1 
#>  5  1971 continent continent   US-AR-24 ; US-AR-2… ""              12.9          12.0 
#>  6  1972 continent continent   US-AR-24 ; US-AR-2… ""              12.8          12.0 
#>  7  1973 continent continent   US-AR-24 ; US-AR-2… ""              11.7          11.0 
#>  8  1974 continent continent   US-AR-24 ; US-AR-2… ""              11.0          10.3 
#>  9  1975 continent continent   US-AR-24 ; US-AR-2… ""              10.3           9.67
#> 10  1976 continent continent   US-AR-24 ; US-AR-2… ""               9.35          8.76
#> # ℹ 1,472 more rows
#> # ℹ 10 more variables: index_q_0.05 <dbl>, index_q_0.25 <dbl>, index_q_0.75 <dbl>,
#> #   index_q_0.95 <dbl>, index_q_0.975 <dbl>, obs_mean <dbl>, n_routes <int>,
...
#>  1       1967     2023 continent continent   US-AR-24 ; US-AR… ""              -0.874 
#>  2       1967     2023 US-AR-24  stratum     US-AR-24          ""               4.41  
#>  3       1967     2023 US-AR-25  stratum     US-AR-25          ""               0.214 
#>  4       1967     2023 US-AR-26  stratum     US-AR-26          ""               4.65  
#>  5       1967     2023 US-KS-18  stratum     US-KS-18          ""               2.81  
#>  6       1967     2023 US-KS-19  stratum     US-KS-19          ""              -0.538 
#>  7       1967     2023 US-KS-22  stratum     US-KS-22          ""              -0.0272
#>  8       1967     2023 US-LA-25  stratum     US-LA-25          ""              -1.25  
#>  9       1967     2023 US-LA-37  stratum     US-LA-37          ""               0.320 
#> 10       1967     2023 US-MO-22  stratum     US-MO-22          ""              -0.356 
#> # ℹ 16 more rows
...
#> #   percent_change_q_0.25 <dbl>, percent_change_q_0.75 <dbl>,
...
#>    start_year end_year region    region_type strata_included   strata_excluded   trend
#>         <dbl>    <dbl> <chr>     <chr>       <chr>             <chr>             <dbl>
#>  1       2011     2021 continent continent   US-AR-24 ; US-AR… ""              -2.00  
#>  2       2011     2021 US-AR-24  stratum     US-AR-24          ""               1.94  
#>  3       2011     2021 US-AR-25  stratum     US-AR-25          ""              -0.411 
#>  4       2011     2021 US-AR-26  stratum     US-AR-26          ""               3.18  
#>  5       2011     2021 US-KS-18  stratum     US-KS-18          ""               4.08  
#>  6       2011     2021 US-KS-19  stratum     US-KS-19          ""               0.982 
#>  7       2011     2021 US-KS-22  stratum     US-KS-22          ""              -3.95  
#>  8       2011     2021 US-LA-25  stratum     US-LA-25          ""              -2.19  
#>  9       2011     2021 US-LA-37  stratum     US-LA-37          ""               1.43  
#> 10       2011     2021 US-MO-22  stratum     US-MO-22          ""               0.0656
#> # ℹ 16 more rows
#> # ℹ 20 more variables: trend_q_0.025 <dbl>, trend_q_0.05 <dbl>, trend_q_0.25 <dbl>,
#> #   trend_q_0.75 <dbl>, trend_q_0.95 <dbl>, trend_q_0.975 <dbl>,
#> #   percent_change <dbl>, percent_change_q_0.025 <dbl>, percent_change_q_0.05 <dbl>,
...
#> $raw_data
#> # A tibble: 13,250 × 23
#>    country_num state_num state     rpid   bcr  year strata_name route   obs_n count
#>          <dbl>     <dbl> <chr>    <dbl> <dbl> <dbl> <chr>       <chr>   <dbl> <dbl>
#>  1         840         7 ARKANSAS   101    24  1967 US-AR-24    7-20  1190020     0
#>  2         840         7 ARKANSAS   101    24  1968 US-AR-24    7-20  1190020     0
#>  3         840         7 ARKANSAS   101    24  1969 US-AR-24    7-20  1190020     0
#>  4         840         7 ARKANSAS   101    24  1970 US-AR-24    7-20  1190020     0
#>  5         840         7 ARKANSAS   101    24  1971 US-AR-24    7-20  1190020     0
#>  6         840         7 ARKANSAS   101    24  1972 US-AR-24    7-20  1190020     0
#>  7         840         7 ARKANSAS   101    24  1973 US-AR-24    7-20  1190020     0
#>  8         840         7 ARKANSAS   101    24  1974 US-AR-24    7-20  1190020     0
#>  9         840         7 ARKANSAS   101    24  1975 US-AR-24    7-20  1190020     0
#> 10         840         7 ARKANSAS   101    24  1976 US-AR-24    7-20  1190020     0
#> # ℹ 13,240 more rows
#> # ℹ 13 more variables: n_routes <int>, non_zero_weight <dbl>, first_year <dbl>,
#> #   max_n_routes_year <int>, n_obs <int>, mean_obs <dbl>, year_num <dbl>,
#> #   strata <dbl>, observer <int>, site <int>, obs_route <chr>, obs_site <int>,
#> #   n_obs_sites <int>
```
