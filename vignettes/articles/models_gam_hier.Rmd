...
#> Chain 1 Exception: neg_binomial_2_log_lpmf: Precision parameter is 0, but must be positive finite! (in '/tmp/RtmpMgb4Bj/model-77e638512b85.stan', line 222, column 3 to column 40)
...
#> Chain 2 Exception: neg_binomial_2_log_lpmf: Precision parameter is 0, but must be positive finite! (in '/tmp/RtmpMgb4Bj/model-77e638512b85.stan', line 222, column 3 to column 40)
...
#> Saving model output to /home/steffi/Projects/Business/ECCC/bbsBayes2/vignettes/articles/BBS_STAN_gam_hier_2023-01-20.rds
```
...
#>    <chr>         <chr>         <dbl>    <dbl>    <dbl>
#>  1 lp__          lp__           1.88       10       10
#>  2 strata_raw    strata_raw[1]  1.18       10       10
#>  3 strata_raw    strata_raw[2]  1.41       10       10
#>  4 strata_raw    strata_raw[3]  1.28       10       10
#>  5 strata_raw    strata_raw[4]  1.16       10       10
#>  6 strata_raw    strata_raw[5]  1.37       10       10
#>  7 strata_raw    strata_raw[6]  1.14       10       10
#>  8 strata_raw    strata_raw[7]  1.75       10       10
#>  9 strata_raw    strata_raw[8]  1.46       10       10
#> 10 strata_raw    strata_raw[9]  1.56       10       10
...
#> [1] "BBS_STAN_gam_hier_2023-01-20-1.csv" "BBS_STAN_gam_hier_2023-01-20-2.csv"
#> [3] "BBS_STAN_gam_hier_2023-01-20.rds"
