...
For most of these examples, we will be using a series of saved model outputs. These model outputs can be downloaded from this [Google Drive](https://drive.google.com/drive/folders/1v3Cb33Z8b-Ac4RXnMLpr8iqUbXoNioeK?usp=sharing)
...
<img src="figures/advanced_unnamed-chunk-3-1.png" alt="Posterior predictive check using overlaying the observed proportion of integer count values and the estimated proportion of count values"  />
...
bbsBayes includes an alternate trend estimate that can be applied to any of the
