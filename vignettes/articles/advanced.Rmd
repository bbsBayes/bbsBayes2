...
<img src="figures/advanced_unnamed-chunk-7-1.png" alt="Population trend map for Barn Swallow, showing strata with increasing trends in shades of blue and strata with decreasing trends in shades of red"  />
Then, to get a sense of the uncertainty in this pattern of trend estimates, we generate two maps that each display the upper and lower credible intervals of the trends. We can interpret these maps as showing the lower-bound and the upper-bound on the rates of population change for the species. For example, we can be reasonably confident that the species' trends have not been more negative than the map on the left, and are unlikely to be more positive than the map on the right.
...
#> Error: <text>:15:56: unexpected symbol
#> 21: negative binomial distribution. This selection is controlled using the
#> 22: `
#>                                                            ^
```
...
<img src="figures/advanced_unnamed-chunk-10-1.png" alt="Map of population trends for Scissor-tailed Flycatcher from 1980-2021, using the default end-point trend estimates"  />
...
<img src="figures/advanced_unnamed-chunk-11-1.png" alt="Map of population trends for Scissor-tailed Flycatcher from 1980-2021, using the slope-based trend estimates"  />
...
<img src="figures/advanced_unnamed-chunk-15-1.png" alt="Population trajectories for Barn Swallow in the northern and southern parts of their range"  />
...
<img src="figures/advanced_unnamed-chunk-28-1.png" alt="Cross validation differences"  />
