...
s[["routes_strata"]]
#> # A tibble: 124,819 × 33
#>    country_num state_num route route_name active latitude longitude
#>          <dbl>     <dbl> <chr> <chr>       <dbl>    <dbl>     <dbl>
#>  1         840         2 2-1   ST FLORIAN      1     34.9     -87.6
#>  2         840         2 2-1   ST FLORIAN      1     34.9     -87.6
#>  3         840         2 2-1   ST FLORIAN      1     34.9     -87.6
#>  4         840         2 2-1   ST FLORIAN      1     34.9     -87.6
#>  5         840         2 2-1   ST FLORIAN      1     34.9     -87.6
#>  6         840         2 2-1   ST FLORIAN      1     34.9     -87.6
#>  7         840         2 2-1   ST FLORIAN      1     34.9     -87.6
#>  8         840         2 2-1   ST FLORIAN      1     34.9     -87.6
#>  9         840         2 2-1   ST FLORIAN      1     34.9     -87.6
#> 10         840         2 2-1   ST FLORIAN      1     34.9     -87.6
#> # ℹ 124,809 more rows
#> # ℹ 26 more variables: bcr <dbl>, route_type_id <dbl>,
#> #   route_type_detail_id <dbl>, route_data_id <dbl>, rpid <dbl>,
#> #   year <dbl>, month <dbl>, day <dbl>, obs_n <dbl>,
#> #   total_spp <dbl>, start_temp <dbl>, end_temp <dbl>,
#> #   temp_scale <chr>, start_wind <dbl>, end_wind <dbl>,
#> #   start_sky <dbl>, end_sky <dbl>, start_time <dbl>, …
```
...
#> Warning: Many strata with data may have been excluded With latlong
#> stratification, most strata have only 1 route. You may wish to set
#> min_n_routes = 1
...
#> 'output/BBS_STAN_slope_hier_2023-07-05.rds', probable reason 'No
...
``` r
names(bbs_strata)
#> [1] "bbs_usgs"   "bbs_cws"    "bcr"        "latlong"   
#> [5] "prov_state"
head(bbs_strata[["bbs_cws"]])
#> # A tibble: 6 × 7
#>   strata_name area_sq_km country country_code prov_state   bcr
#>   <chr>            <dbl> <chr>   <chr>        <chr>      <dbl>
#> 1 CA-AB-10        52565. Canada  CA           AB            10
#> 2 CA-AB-11       149352. Canada  CA           AB            11
#> 3 CA-AB-6        445135. Canada  CA           AB             6
#> 4 CA-AB-8          6987. Canada  CA           AB             8
#> 5 CA-BC-10       383006. Canada  CA           BC            10
#> 6 CA-BC-4        193180. Canada  CA           BC             4
#> # ℹ 1 more variable: bcr_by_country <chr>
```
...
#>  2 CA-AB-11       149352. Canada  CA           AB            11
#>  3 CA-AB-6        445135. Canada  CA           AB             6
#>  4 CA-BC-10       383006. Canada  CA           BC            10
#>  5 CA-BC-4        193180. Canada  CA           BC             4
#>  6 CA-BC-5        199820. Canada  CA           BC             5
#>  7 CA-BC-6        106917. Canada  CA           BC             6
#>  8 CA-BC-9         59939. Canada  CA           BC             9
#>  9 CA-BCR7-7     1743744. Canada  CA           BCR7           7
#> 10 CA-MB-11        70101. Canada  CA           MB            11
#> 11 CA-MB-12        15312. Canada  CA           MB            12
#> 12 CA-MB-6        127190. Canada  CA           MB             6
#> 13 CA-MB-8        234151. Canada  CA           MB             8
#> 14 CA-NB-14        72991. Canada  CA           NB            14
#> 15 CA-NL-8        157083. Canada  CA           NL             8
#> 16 CA-NSPE-14      61502. Canada  CA           NSPE          14
#> 17 CA-NT-3        394769. Canada  CA           NT             3
#> 18 CA-NT-6        509423. Canada  CA           NT             6
#> 19 CA-NU-3       1969549. Canada  CA           NU             3
#> 20 CA-ON-12       206181. Canada  CA           ON            12
#> 21 CA-ON-13        83859. Canada  CA           ON            13
#> 22 CA-ON-8        435545. Canada  CA           ON             8
#> 23 CA-QC-12       174314. Canada  CA           QC            12
#> 24 CA-QC-13        28409. Canada  CA           QC            13
#> 25 CA-QC-14        67711. Canada  CA           QC            14
#> 26 CA-QC-8        470310. Canada  CA           QC             8
#> 27 CA-SK-11       241315. Canada  CA           SK            11
#> 28 CA-SK-6        177763. Canada  CA           SK             6
#> 29 CA-SK-8        188615. Canada  CA           SK             8
#> 30 CA-YT-4        435349. Canada  CA           YT             4
#> # ℹ 1 more variable: bcr_by_country <chr>
```
