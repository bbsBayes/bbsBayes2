...
#> Chain 1 Exception: neg_binomial_2_log_lpmf: Precision parameter is 0, but must be positive finite! (in '/tmp/RtmpMgb4Bj/model-77e62ce876b3.stan', line 221, column 3 to column 40)
...
#> Chain 2 Exception: neg_binomial_2_log_lpmf: Precision parameter is 0, but must be positive finite! (in '/tmp/RtmpMgb4Bj/model-77e62ce876b3.stan', line 221, column 3 to column 40)
...
#> Chain 2 finished in 129.4 seconds.
#> Chain 1 finished in 137.6 seconds.
#> 
#> Both chains finished successfully.
#> Mean chain execution time: 133.5 seconds.
#> Total execution time: 137.7 seconds.
#> Warning: 2 of 2 chains had an E-BFMI less than 0.2.
#> See https://mc-stan.org/misc/warnings for details.
#> Saving model output to /home/steffi/Projects/Business/ECCC/bbsBayes2/vignettes/articles/BBS_STAN_slope_spatial_2023-01-20.rds
```
...
#>    <chr>         <chr>         <dbl>    <dbl>    <dbl>
#>  1 lp__          lp__           1.63       10       10
#>  2 strata_raw    strata_raw[1]  1.30       10       10
#>  3 strata_raw    strata_raw[2]  1.17       10       10
#>  4 strata_raw    strata_raw[3]  1.13       10       10
#>  5 strata_raw    strata_raw[4]  1.62       10       10
#>  6 strata_raw    strata_raw[5]  1.10       10       10
#>  7 strata_raw    strata_raw[6]  1.30       10       10
#>  8 strata_raw    strata_raw[7]  1.84       10       10
#>  9 strata_raw    strata_raw[8]  1.56       10       10
#> 10 strata_raw    strata_raw[9]  1.46       10       10
...
#> [1] "BBS_STAN_slope_spatial_2023-01-20-1.csv" "BBS_STAN_slope_spatial_2023-01-20-2.csv"
#> [3] "BBS_STAN_slope_spatial_2023-01-20.rds"
