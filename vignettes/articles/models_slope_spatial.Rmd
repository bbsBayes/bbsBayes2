...
#> Chain 1 Exception: neg_binomial_2_log_lpmf: Precision parameter is 0, but must be positive finite! (in '/tmp/RtmpRvZIkx/model-18c4624601c.stan', line 221, column 3 to column 40)
...
#> Chain 2 Exception: neg_binomial_2_log_lpmf: Precision parameter is 0, but must be positive finite! (in '/tmp/RtmpRvZIkx/model-18c4624601c.stan', line 221, column 3 to column 40)
...
#> Chain 2 finished in 144.0 seconds.
#> Chain 1 Iteration: 20 / 20 [100%]  (Sampling) 
#> Chain 1 finished in 185.6 seconds.
#> 
#> Both chains finished successfully.
#> Mean chain execution time: 164.8 seconds.
#> Total execution time: 185.7 seconds.
#> Warning: 9 of 20 (45.0%) transitions hit the maximum treedepth limit of 14.
#> See https://mc-stan.org/misc/warnings for details.
#> Saving model output to /home/steffi/Projects/Business/ECCC/bbsBayes2/vignettes/articles/BBS_STAN_slope_spatial_2023-01-17.rds
```
...
#>    <chr>         <chr>         <dbl>    <dbl>    <dbl>
#>  1 lp__          lp__           1.77       10       10
#>  2 strata_raw    strata_raw[1]  1.38       10       10
#>  3 strata_raw    strata_raw[2]  1.46       10       10
#>  4 strata_raw    strata_raw[3]  1.07       10       10
#>  5 strata_raw    strata_raw[4]  1.32       10       10
#>  6 strata_raw    strata_raw[5]  1.49       10       10
#>  7 strata_raw    strata_raw[6]  1.35       10       10
#>  8 strata_raw    strata_raw[7]  1.76       10       10
#>  9 strata_raw    strata_raw[8]  1.50       10       10
#> 10 strata_raw    strata_raw[9]  1.26       10       10
...
#> [1] "BBS_STAN_slope_spatial_2023-01-17-1.csv" "BBS_STAN_slope_spatial_2023-01-17-2.csv"
#> [3] "BBS_STAN_slope_spatial_2023-01-17.rds"
