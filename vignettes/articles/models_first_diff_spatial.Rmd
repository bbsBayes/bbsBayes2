...
#> Chain 1 Exception: neg_binomial_2_log_lpmf: Precision parameter is 0, but must be positive finite! (in '/tmp/RtmpMgb4Bj/model-77e66430fb8f.stan', line 240, column 3 to column 40)
...
#> Chain 1
#> Chain 1 Informational Message: The current Metropolis proposal is about to be rejected because of the following issue:
#> Chain 1 Exception: neg_binomial_2_log_lpmf: Log location parameter[1] is -nan, but must be finite! (in '/tmp/RtmpMgb4Bj/model-77e66430fb8f.stan', line 240, column 3 to column 40)
#> Chain 1 If this warning occurs sporadically, such as for highly constrained variable types like covariance matrices, then the sampler is fine,
#> Chain 1 but if this warning occurs often then your model may be either severely ill-conditioned or misspecified.
#> Chain 1
#> Chain 1 Informational Message: The current Metropolis proposal is about to be rejected because of the following issue:
...
#> Chain 2 Exception: neg_binomial_2_log_lpmf: Precision parameter is 0, but must be positive finite! (in '/tmp/RtmpMgb4Bj/model-77e66430fb8f.stan', line 240, column 3 to column 40)
...
#> Chain 2
#> Chain 2 Informational Message: The current Metropolis proposal is about to be rejected because of the following issue:
#> Chain 2 Exception: neg_binomial_2_log_lpmf: Log location parameter[1] is -nan, but must be finite! (in '/tmp/RtmpMgb4Bj/model-77e66430fb8f.stan', line 240, column 3 to column 40)
#> Chain 2 If this warning occurs sporadically, such as for highly constrained variable types like covariance matrices, then the sampler is fine,
#> Chain 2 but if this warning occurs often then your model may be either severely ill-conditioned or misspecified.
#> Chain 2
#> Chain 2 Informational Message: The current Metropolis proposal is about to be rejected because of the following issue:
...
#> Saving model output to /home/steffi/Projects/Business/ECCC/bbsBayes2/vignettes/articles/BBS_STAN_first_diff_spatial_2023-01-20.rds
```
...
#>    <chr>         <chr>         <dbl>    <dbl>    <dbl>
#>  1 lp__          lp__          1.78        10       10
#>  2 strata_raw    strata_raw[1] 1.07        10       10
#>  3 strata_raw    strata_raw[2] 1.19        10       10
#>  4 strata_raw    strata_raw[3] 0.965       10       10
#>  5 strata_raw    strata_raw[4] 1.13        10       10
#>  6 strata_raw    strata_raw[5] 1.10        10       10
#>  7 strata_raw    strata_raw[6] 1.27        10       10
#>  8 strata_raw    strata_raw[7] 1.27        10       10
#>  9 strata_raw    strata_raw[8] 1.22        10       10
#> 10 strata_raw    strata_raw[9] 0.972       10       10
#> # … with 10,485 more rows
```
...
#> [1] "BBS_STAN_first_diff_spatial_2023-01-20-1.csv" "BBS_STAN_first_diff_spatial_2023-01-20-2.csv"
#> [3] "BBS_STAN_first_diff_spatial_2023-01-20.rds"
...
#>  bbsBayes2      * 1.0.0   2023-01-20 [1] local
...
#>  rnaturalearth    0.1.0   2017-03-21 [1] CRAN (R 4.2.1)
#>  rprojroot        2.0.3   2022-04-02 [1] CRAN (R 4.2.0)
#>  rstudioapi       0.14    2022-08-22 [1] CRAN (R 4.2.1)
#>  s2               1.0.7   2021-09-28 [1] CRAN (R 4.2.0)
#>  sbtools          1.1.18  2022-05-26 [1] CRAN (R 4.2.0)
