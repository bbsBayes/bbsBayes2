...
- run_model(md, iter_sampling = 10, iter_warmup = 10, chains = 2)
#> One set of `init` values supplied, duplicating for each chain.
#> Compiling Stan program...
#> -\|/-\|/-\|/-\|/-\|/-\|/-\|/-\|/-\|/-\|/-\|/-\|/-\|/-\|/-\|/-\|/-\|/-\|/-\|/-\|/-\|/-\|/-\|/-\|/-\
...
#> Chain 1 Exception: neg_binomial_2_log_lpmf: Precision parameter is 0, but must be positive finite! (in '/tmp/RtmpMgb4Bj/model-77e63257da69.stan', line 238, column 3 to column 40)
...
#> Chain 2 Exception: neg_binomial_2_log_lpmf: Precision parameter is 0, but must be positive finite! (in '/tmp/RtmpMgb4Bj/model-77e63257da69.stan', line 238, column 3 to column 40)
...
#> Mean chain execution time: 20.3 seconds.
#> Total execution time: 20.8 seconds.
#> Warning: 1 of 2 chains had an E-BFMI less than 0.2.
#> See https://mc-stan.org/misc/warnings for details.
#> Saving model output to /home/steffi/Projects/Business/ECCC/bbsBayes2/vignettes/articles/BBS_STAN_gamye_hier_2023-01-20.rds
```
...
#>    <chr>         <chr>         <dbl>    <dbl>    <dbl>
#>  1 lp__          lp__          1.38        10       10
#>  2 strata_raw    strata_raw[1] 0.942       10       10
#>  3 strata_raw    strata_raw[2] 1.04        10       10
#>  4 strata_raw    strata_raw[3] 0.988       10       10
#>  5 strata_raw    strata_raw[4] 1.06        10       10
#>  6 strata_raw    strata_raw[5] 1.17        10       10
#>  7 strata_raw    strata_raw[6] 1.19        10       10
#>  8 strata_raw    strata_raw[7] 1.04        10       10
#>  9 strata_raw    strata_raw[8] 1.21        10       10
#> 10 strata_raw    strata_raw[9] 0.982       10       10
#> # … with 11,908 more rows
```
...
#> [1] "BBS_STAN_gamye_hier_2023-01-20-1.csv" "BBS_STAN_gamye_hier_2023-01-20-2.csv"
#> [3] "BBS_STAN_gamye_hier_2023-01-20.rds"
