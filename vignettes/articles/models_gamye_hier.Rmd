...
#> Chain 1 Exception: neg_binomial_2_log_lpmf: Precision parameter is 0, but must be positive finite! (in '/tmp/RtmpRvZIkx/model-18c466af409ca.stan', line 238, column 3 to column 40)
...
#> Chain 2 Exception: neg_binomial_2_log_lpmf: Precision parameter is 0, but must be positive finite! (in '/tmp/RtmpRvZIkx/model-18c466af409ca.stan', line 238, column 3 to column 40)
...
#> Saving model output to /home/steffi/Projects/Business/ECCC/bbsBayes2/vignettes/articles/BBS_STAN_gamye_hier_2023-01-17.rds
```
...
#>  2 strata_raw    strata_raw[1] 1.05        10       10
#>  3 strata_raw    strata_raw[2] 1.05        10       10
#>  4 strata_raw    strata_raw[3] 0.980       10       10
#>  5 strata_raw    strata_raw[4] 1.41        10       10
#>  6 strata_raw    strata_raw[5] 0.926       10       10
#>  7 strata_raw    strata_raw[6] 0.950       10       10
#>  8 strata_raw    strata_raw[7] 1.82        10       10
#>  9 strata_raw    strata_raw[8] 1.67        10       10
#> 10 strata_raw    strata_raw[9] 1.21        10       10
...
#> [1] "BBS_STAN_gamye_hier_2023-01-17-1.csv" "BBS_STAN_gamye_hier_2023-01-17-2.csv"
#> [3] "BBS_STAN_gamye_hier_2023-01-17.rds"
