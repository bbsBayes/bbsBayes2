...
#> Chain 1 Exception: neg_binomial_2_log_lpmf: Precision parameter is 0, but must be positive finite! (in '/tmp/RtmpRvZIkx/model-18c463ceec023.stan', line 230, column 3 to column 40)
...
#> Chain 2 Exception: neg_binomial_2_log_lpmf: Precision parameter is 0, but must be positive finite! (in '/tmp/RtmpRvZIkx/model-18c463ceec023.stan', line 230, column 3 to column 40)
...
#> See https://mc-stan.org/misc/warnings for details.
#> Saving model output to /home/steffi/Projects/Business/ECCC/bbsBayes2/vignettes/articles/BBS_STAN_gam_spatial_2023-01-17.rds
```
...
#>    <chr>         <chr>         <dbl>    <dbl>    <dbl>
#>  1 lp__          lp__          1.94        10       10
#>  2 strata_raw    strata_raw[1] 1.17        10       10
#>  3 strata_raw    strata_raw[2] 1.29        10       10
#>  4 strata_raw    strata_raw[3] 1.06        10       10
#>  5 strata_raw    strata_raw[4] 1.55        10       10
#>  6 strata_raw    strata_raw[5] 1.01        10       10
#>  7 strata_raw    strata_raw[6] 1.33        10       10
#>  8 strata_raw    strata_raw[7] 1.02        10       10
#>  9 strata_raw    strata_raw[8] 1.23        10       10
#> 10 strata_raw    strata_raw[9] 0.974       10       10
...
#> [1] "BBS_STAN_gam_spatial_2023-01-17-1.csv" "BBS_STAN_gam_spatial_2023-01-17-2.csv"
#> [3] "BBS_STAN_gam_spatial_2023-01-17.rds"
