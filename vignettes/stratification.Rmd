...
download.file(url = "https://ecos.fws.gov/ServCat/DownloadFile/213149",
              destfile = t)
unzip(t)  # Unzip
unlink(t) # Remove the zipped file
```
...
We'll modify this by first looking only at provinces (omitting the northern territories) and transforming to the GPS CRS (4326).
```{r}
new_map <- map %>%
